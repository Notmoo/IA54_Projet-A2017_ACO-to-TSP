...
import gui.graph.cell.impl.RectangleCell;
import gui.graph.cell.impl.SimpleCell;
import gui.graph.edge.Edge;
...
public class Model {
    ...
    public void addCell(String id, CellType type) {
        ...
        switch (type) {
            ...
            case RECTANGLE:
                Cell rectangleCell = new RectangleCell(id);
                addCell(rectangleCell);
                break;

            case SIMPLE:
                Cell simpleCell = new SimpleCell(id);
                addCell(simpleCell);
                break;
